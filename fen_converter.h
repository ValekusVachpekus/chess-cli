 ...
 * NOTE: This header must be used AFTER the Board, Figure, and King/Ladya
 * classes are defined in gameboard.cpp
 */
 ...
 * @param castling_white_queenside whether white queen-side castling is
 * available
 * @param castling_black_kingside whether black king-side castling is available
 * @param castling_black_queenside whether black queen-side castling is
 * available
